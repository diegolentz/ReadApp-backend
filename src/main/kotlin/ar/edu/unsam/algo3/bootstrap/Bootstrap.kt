...
object Bootstrap : CommandLineRunner {
    ...
    private fun createBooks(autores:List<Autor>){
        val libro_1: Libro = LibroBuilder()
            .titulo("La sombra sobre Innsmouth").autor(ar.edu.unsam.algo3.mock.autores.random())
        ...
        val libro_2: Libro = LibroBuilder()
            .titulo("Caminos de fuego").autor(ar.edu.unsam.algo3.mock.autores.random())
        ...
        val libro_3: Libro = LibroBuilder()
            .titulo("Sombras en la noche").autor(ar.edu.unsam.algo3.mock.autores.random())
        ...
        val libro_4: Libro = LibroBuilder()
            .titulo("El mar en calma y viaje feliz").autor(ar.edu.unsam.algo3.mock.autores.random())
        ...
        val libro_5: Libro = LibroBuilder()
            .titulo("Ultima frontera").autor(ar.edu.unsam.algo3.mock.autores.random())
        ...
        val libro_6: Libro = LibroBuilder()
            .titulo("El ultimo refugio").autor(ar.edu.unsam.algo3.mock.autores.random())
        ...
        val libro_8: Libro = LibroBuilder()
            .titulo("El misterio del lago").autor(ar.edu.unsam.algo3.mock.autores.random())
        ...
        val libro_9: Libro = LibroBuilder()
            .titulo("La ciudad perdida").autor(ar.edu.unsam.algo3.mock.autores.random())
        ...
        val libro_10: Libro = LibroBuilder()
            .titulo("Sombras de la noche II").autor(ar.edu.unsam.algo3.mock.autores.random())
        ...
        val libro_11: Libro = LibroBuilder()
            .titulo("El mar en calma y viaje feliz II").autor(ar.edu.unsam.algo3.mock.autores.random())
        ...
        val libro_12: Libro = LibroBuilder()
            .titulo("El bosque negro").autor(ar.edu.unsam.algo3.mock.autores.random())
