...
object ServiceLibros {
    ...
    init {
        ...
        repoLibro.create(libro9)
        repoLibro.create(libro10)
        repoLibro.create(libro11)
        repoLibro.create(libro12)
    }
